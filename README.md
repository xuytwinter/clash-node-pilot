...
- macOS external testing: download the `clash-node-pilot-macos-preview-zips` CI artifact and follow `docs/macos-external-smoke-test.md`.
- 中文 macOS 测试清单：`docs/macos-external-smoke-test.zh-CN.md`。
...
- Android device testing: download the `clash-node-pilot-android-debug-apk` CI artifact and follow `docs/android-device-smoke-test.md`.
- 中文 Android 真机测试清单：`docs/android-device-smoke-test.zh-CN.md`。
